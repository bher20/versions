...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { change_log: @version.change_log, comment: @version.comment, version: @version.version }
    end
  ...
  test "should update version" do
    put :update, id: @version, version: { change_log: @version.change_log, comment: @version.comment, version: @version.version }
    assert_redirected_to version_path(assigns(:version))
  end
